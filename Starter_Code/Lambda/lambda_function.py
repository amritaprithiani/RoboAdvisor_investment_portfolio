...
4. Once the intent is fulfilled, the bot should respond with an investment recommendation 
based on the selected risk level as follows:
...
> **Hint:** Be creative while coding your solution, you can have all the code on the `recommend_portfolio()` 
...
6. After successfully testing your code, open the Amazon Lex Console and navigate to the 
`recommendPortfolio` bot configuration, integrate your new Lambda function by selecting it in the
 “Lambda initialization and validation” and “Fulfillment” sections.
    ...
    if age is not None:
        if (age <= 0 or age > 65):
            return build_validation_result(
                False,
                "age",
                "The age should less than 65 years old to use this service"
                "Please enter a different age."
            )
            
#  Validate data for investment amount
...
def investment_recommendation(risk_level):
    ...
    recommendation = ""
    if risk_level == 'None':
        recommendation = "Recommended investment is 100% bonds (AGG), 0% equities (SPY)."
    elif risk_level == 'Low':
        recommendation = "Recommended investment is 60% bonds (AGG), 40% equities (SPY)."
    elif risk_level == 'Medium':
        recommendation = "Recommended investment is 40% bonds (AGG), 60% equities (SPY)."
    elif risk_level == 'High':
        recommendation = "Recommended investment is 20% bonds (AGG), 80% equities (SPY)."
    else:
...
def recommend_portfolio(intent_request):
    ...
    return close(
        ...
        "Fulfilled",
        {
            ...
            {}
            """.format(
                 investment_recommendation(risk_level)
            ),
        },
    )
